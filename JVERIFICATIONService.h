...
#define JVER_VERSION_NUMBER 3.0.1
...
/*是否在未勾选隐私协议的情况下 弹窗提示窗口 YES时 设置页面各控件frame*/
@property (nonatomic,copy) void(^resetAgreementAlertViewFrameBlock)(NSValue  *_Nullable* _Nullable  alertViewFrame , NSValue  *_Nullable* _Nullable titleFrame , NSValue  *_Nullable* _Nullable contentFrame, NSValue  *_Nullable* _Nullable buttonFrame);
